...
if (isset($_POST["submit"])) 
{
    ...
    $tarpath= "productuploads/";
                    ...
                    $query = "INSERT INTO product (pname,price,description,image,vehiclename,companyname,modelno) Values('$pname','$price','$description','$image','$vehiclename','$companyname','$modelno')";
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="addproduct.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Vehicle Name" name="vehiclename">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Company Name</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Company Name" name="companyname">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Model NO</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Model NO" name="modelno">
                    </div>
                    <div class="form-group">
