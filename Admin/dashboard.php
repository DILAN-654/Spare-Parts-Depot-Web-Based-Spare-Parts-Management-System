        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title text-md-center text-xl-left">No of Employee</p>
                  <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                    <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0"><?php
                                          include 'connection.php';
            ...
            <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <a href="viewproductbooking.php" style="text-decoration:none">
                <div class="card-body">
                  <p class="card-title text-md-center text-xl-left">No of Pending Product Bookings</p>
                  <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                    <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0"><?php
                                          include 'connection.php';
          
                
                                          $query = "SELECT count(*) as total from productbooking WHERE status='pending'";
                                          $result = $conn->query($query);
                                          if ($result->num_rows > 0 ){
                                          while ($row = $result->fetch_object()){
                                            $total= $row->total;
